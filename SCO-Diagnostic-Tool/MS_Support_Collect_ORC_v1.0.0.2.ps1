...
v0.0.0.1
===========
Added functions to export: RegKeys, EventLog, Services, Processes, MSInfo32

v0.0.0.2
===========
Added support for sample of SQL queries execution

v0.0.0.3
===========
Added additional queries for Runbook execution check

v0.0.0.4
===========
Added function to export LogFiles and Installation LogFiles

v0.0.0.5
===========
Added log purge settings

v0.0.0.6
===========
Added automatic ORCH SQL instance discovery

v0.0.0.7
===========
MSinfo32 export to .txt
Added localmetadata for event log export
Added some extra support system functions

v0.0.0.8
===========
Added export ecryp keys over ORCH db 

v0.0.0.9
===========
Improve ORCH db discovery
Added PS transcript
Added Zip function
Added *DO NOT Exist Script* feature

v1.0.0.0
===========
Fixed transcript elevation error

v1.0.0.2
===========
Reg file in TLS folder
Included more info on services.txt
